window.DUODECIMA_SYSTEM = {
  conditions: [
    ...
    {name:'Indefeso', mechanic:'Sem conseguir se defender. O alvo não rola mais testes de Defesa; em vez disso, sua Defesa / CA padrão é 5.', fixedDefense:5},
    {name:'Inconsciente', mechanic:'Fica indefeso e incapaz de agir. Ataques corpo a corpo contra uma criatura inconsciente são considerados acertos críticos.', fixedDefense:5},
    ...
    {name:'Paralisado', mechanic:'Fica indefeso e incapaz de se mover. Força e Destreza efetivas passam a -1, mas ações puramente mentais ainda são possíveis.', fixedDefense:5},
