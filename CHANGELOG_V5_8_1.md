...
- Dano aplicado pelo controle de HP consome primeiro os HP temporários; cura continua afetando apenas o HP normal.
- HP temporário não é restaurado por descanso longo.
- Estado da bênção e HP temporário entram no salvamento local e no JSON exportado.
